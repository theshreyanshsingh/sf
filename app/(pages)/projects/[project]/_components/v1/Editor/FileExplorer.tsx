...
import useWebContainerFiles from "../useWebContainerFiles";
import { useWebContainerContext } from "@/app/redux/useWebContainerContext";
import { createFileSystemOperations } from "@/app/helpers/fileSystemOperations";
...
const FileExplorer = () => {
  ...
  const { files: rawFiles } = useSelector(
  ...
  // Get file operations from the custom hook
  const { renameEntry, deleteEntry } = useWebContainerFiles();
  ...
  }, [webcontainerInstance, dispatch, fileSystemData]);
  ...
  const handleDelete = useCallback(
    ...
    [rawFiles, dispatch, currentFile, webcontainerInstance, deleteEntry]
  );
  ...
  const handleRename = useCallback(
    ...
    [rawFiles, dispatch, currentFile, webcontainerInstance, renameEntry]
  );

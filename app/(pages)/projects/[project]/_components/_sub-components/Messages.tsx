...
const MessageAttachments = ({
  ...
  return (
    <div
      className={`w-full flex gap-2 overflow-x-auto no-scrollbar ${alignment === "end" ? "justify-end" : "justify-start"
        }`}
    >
      <AnimatePresence>
    ...
    try {
      ...
      if (data.success && data.codeUrl) {
        try {
          ...
          throw new Error(
            `Failed to fetch code: ${fetchError instanceof Error ? fetchError.message : "Unknown error"
            }`
          );
        }
      }
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        const findCodeUrlForUserMessage = (userMsgIndex: number): { id: string; codeUrl: string } | null => {
                            ...
                            <div className="flex justify-end mt-2">
                              ...
                              >
                                {restoringMessageId === codeInfo.id ? (
                                  ...
                                  <>
                                    <FaUndo className="flex-shrink-0" size={10} />
                                    Restore
                                  </>
                                )}
                              </button>
